...
function tlw_scripts() {
	...
	wp_enqueue_script( 'functions', get_stylesheet_directory_uri() . '/_/js/functions-min.js', array('jquery','bootstrap-select', 'jquery-cookie', 'slim-scroll'), filemtime( get_stylesheet_directory().'/_/js/functions.js' ), true );
