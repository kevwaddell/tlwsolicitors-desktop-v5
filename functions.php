...
function tlw_scripts() {
	...
	wp_enqueue_style( 'styles', get_stylesheet_directory_uri().'/_/css/styles.css', array('twitter-bootstrap', 'A2A_SHARE_SAVE', 'gforms_css'), filemtime( get_stylesheet_directory().'/_/css/styles.css' ), 'screen' );
